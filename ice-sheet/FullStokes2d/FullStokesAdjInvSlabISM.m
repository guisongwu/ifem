%% FULLSTOKESADJINVSLABISM PHGISM-parameter slab-bed beta inversion.
%
% This is the PHGISM-internal-unit counterpart of
% FullStokesAdjInvSlab.m.  The original script uses nondimensional
% data.  This version follows the constants in
...
% The nondimensional slab L=4, H=1, h=0.1 is interpreted directly in
...
fprintf('ISM slab inversion: L=%.2f km, H=%.2f km, h=%.2f km\n',...
    L,H,h);
