%% FULLSTOKESADJINVSIN Invert beta on a sinusoidal bed.
%
% This script follows FullStokesAdjInvSlab.m, but uses an
...
fprintf('Sin-bed inversion: L=%.2f, H=%.2f, h=%.2f, Nx=%d, Nz=%d\n',...
    L,H,h,Nx,Nz);
