%% HOM_CADJINVISM Adjoint beta inversion with x/y periodic boundaries.
%
% This is a PHGISM-internal-unit inverse-crime test on the 3-D ISMIP-HOM-C
% geometry.  Coordinates are in km, velocity is in m/year, beta is the
% physical basal coefficient in Pa yr m^{-1}, and pressure output is the
% PHGISM pressure DOF p/1e5.
