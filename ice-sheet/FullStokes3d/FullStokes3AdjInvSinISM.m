%% FULLSTOKES3ADJINVSINISM 3-D adjoint beta inversion on a sinusoidal bed.
%
% This is a PHGISM-internal-unit 3-D sinusoidal-bed inverse example.
% Coordinates are in km, velocity is in m/year, beta is the physical basal
% coefficient in Pa yr m^{-1}, and pressure output is the PHGISM pressure
% DOF p/1e5.
...
clear diaryCleanup;
    ...
    fprintf(2,'\nFullStokes3AdjInvSinISM failed. Console output saved to %s\n',...
        diaryFile);
