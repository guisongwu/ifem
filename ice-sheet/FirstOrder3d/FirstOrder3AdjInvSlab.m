%% FIRSTORDER3ADJINVSLAB 3-D first-order adjoint beta inversion on a slab bed.
%
...
% boundary of a periodic sloping slab.
...
fprintf(['3-D FO slab-bed beta inversion: L = %.04e, ',...
    'W = %.04e, H = %.04e\n'],L,W,H);
