%% FIRSTORDER3ADJINVSINISM PHGISM-parameter 3-D FO sinusoidal-bed inversion.
%
...
% boundary.  Coordinates are in km, velocities are in m/year, and beta is
% the PHGISM basal friction coefficient.
...
fprintf(['3-D FO ISM sinusoidal-bed beta inversion: L = %.2f km, ',...
    'W = %.2f km, H = %.2f km\n'],L,W,H);
...
xlabel('x'); ylabel('y'); zlabel('\beta');
sgtitle('3-D FO ISM sinusoidal-bed beta inversion');
...
clear diaryCleanup;
    ...
    fprintf(2,'\nFirstOrder3AdjInvSinISM failed. Console output saved to %s\n',...
        diaryFile);
