%% FIRSTORDERADJINVSINISM PHGISM-parameter 2-D FO sinusoidal-bed inversion.
%
% First-order counterpart of ../FullStokes2d/FullStokesAdjInvSinISM.m.
...
% Fixed-thickness cases.  Set foInvConfig.domainCase to compare how
...
fprintf(['FO ISM sin-bed beta inversion case %s: L = %.2f km, ',...
    'H = %.2f km, h = %.2f km, Nx = %d, Nz = %d\n'],...
...
perturbationCase = getconfig(foInvConfig,'perturbationCase','sin1cos2');
...
title(sprintf('FO ISM sin-bed beta inversion: true %s, perturbation %s',...
...
subplot(1,2,1);
showmesh(node,elem);
title('FO ISM sinusoidal-bed mesh','FontSize',14);
