function fig = FirstOrderVisualize(option,soln,eqn,info,node,elem,bdFlag)
%% FIRSTORDERVISUALIZE Visualize the 2-D x-z FO solution.
%
% Example:
%
%   FirstOrderVisualize
...
%   FirstOrderVisualize(option,soln,eqn,info,node,elem,bdFlag)
...
if exportPng
    ...
    exportgraphics(fig,fullfile(outputDir,...
        'FirstOrder-cross-section-u.png'),'Resolution',200);
end
