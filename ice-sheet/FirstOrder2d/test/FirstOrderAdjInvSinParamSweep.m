%% FIRSTORDERADJINVSINPARAMSWEEP Parameter sweep for FO sinusoidal-bed inversion.
%
% Compare lambda, alpha, and eps_reg for FirstOrderAdjInvSin.  The main metrics
