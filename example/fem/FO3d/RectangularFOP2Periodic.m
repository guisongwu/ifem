function [soln,eqn,info,node,elem,bdFlag] = RectangularFOP2Periodic(option)
%% RECTANGULARFOP2PERIODIC FO P2 solver on a periodic rectangular box.
%
...
% Example:
%
%   [soln,eqn,info,node,elem,bdFlag] = RectangularFOP2Periodic;
