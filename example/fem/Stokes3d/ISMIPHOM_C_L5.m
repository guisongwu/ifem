%% ISMIPHOM_C_L5 3-D ISMIP-HOM experiment C, L = 5 km.
%
...
fprintf(['ISMIP-HOM C L=5 km: converged=%d, Picard=%3d, ',...
...
sgtitle('ISMIP-HOM experiment C, L = 5 km');
