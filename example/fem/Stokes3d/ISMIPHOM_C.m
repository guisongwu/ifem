%% ISMIPHOM_C 3-D ISMIP-HOM experiment C forward solve.
%
% Experiment C uses a periodic sloping slab with uniform thickness,
% spatially varying basal friction, and a stress-free upper surface.
...
officialFSMax = [16.00;16.53;19.05;29.32;60.15;143.75];
officialFSMean = [15.99;16.24;16.84;19.76;27.38;41.68];
...
for iLength = 1:numel(lengthList)
    ...
    fprintf(['ISMIP-HOM C L=%6.1f km: converged=%d, Picard=%3d, ',...
...
sgtitle('ISMIP-HOM experiment C: surface speed at y = L/4');
