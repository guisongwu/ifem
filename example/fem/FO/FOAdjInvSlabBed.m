%% FOADJINVSLABBED Adjoint beta inversion for the 2D FO slab model.
%
% This is the first-order counterpart of
% ../NonlinearStokes/NonlinearStokesAdjInvSlabBed.m.  It uses top
% horizontal velocity observations to recover the basal friction
% coefficient beta on a sloping periodic slab.
...
title(sprintf('FO slab-bed beta inversion: true %s, perturbation %s',...
...
subplot(1,2,1);
showmesh(node,elem);
title('FO slab mesh','FontSize',14);
