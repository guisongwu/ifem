%% NONLINEARFOP2VISUALIZE visualize a manufactured FO P2 solution.
%
% The script solves the same manufactured problem used by
% NonlinearFOP2femrate on a moderately refined cube, then plots boundary
...
exportfigure(fig1,outputDir,'NonlinearFOP2-boundary-speed.png',exportPng);
...
exportfigure(fig3,outputDir,'NonlinearFOP2-mid-slice-error.png',exportPng);
